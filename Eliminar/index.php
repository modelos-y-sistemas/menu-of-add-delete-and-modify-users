  ...
  <form method="post" class="form" name="form" id="form" onsubmit="return Eliminar();">
    <div class="filter"> 
      ...
      <div class="controls">
        ...
        <div class="control">
          <label class="filter__label" for="codcurso">CodigoCurso</label>
          <input class="filter__input" type="checkbox" name="codcurso" id="cordcurso">
        </div>
        <div class="control">
    ...
    <table class="list-users" border="1">
      <thead class="list-users__thead">
        <tr class="list-users__tr">
          ...
          <th class="list-users__th"> CodCurso </th>
